...
class RawFile:
  ...
  def __define_criterion(self):
    ...
    if "afd" in input_path:
    ...
    elif "ied" in input_path:
      return lambda col: "_AI_" in col or "_AF_" in col
    elif "atu" in input_path:
      return lambda col: col == "CRE_CAT_0" or col == "PRE_CAT_0" or col == "MULT_ETA_CAT_0" or re.match('^MED_\d{2}_CAT_0$', col) or re.match('^FUN_\d{2}_CAT_0$', col) or "_AI_" in col or "_AF_" in col
    elif "tdi" in input_path:
      ...
      return lambda col: col == "CRE_CAT_0" or col == "PRE_CAT_0" or col == "MED_NS_CAT_01" or "_AI_" in col or "_AF_" in col
